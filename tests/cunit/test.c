...
int main() {
  ...
  CU_TestInfo isstrconcat_tests[] = {{"Test actual a", testStrConcat_True},
                                       {"Test b", testStrConcat_T},
                                       {"Test c", testStrConcat_TR},
                                          CU_TEST_INFO_NULL};
